...
public class city_wise_model {

    private String name, total, death, cured, active, incAct, incDec, incRec;

    public city_wise_model(String name, String total, String death, String cured, String active, String incAct, String incDec, String incRec)
    {
        this.name = name;
        this.total = total;
        this.death = death;
